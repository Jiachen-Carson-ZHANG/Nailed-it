...
// The full appointment calendar. Reached from the 今日 home's technician roll ("完整日历 →").
// Split out of the old /merchant/calendar page when that route became the agent-ops home (audit 2026-07-06).
