...
export const uiMessageKeys = [
  ...
  'tryOn.analyzeBook',
  'tryOn.commentLabel',
  'tryOn.commentPlaceholder',
  'tryOn.commentError',
  'tryOn.quickConfirm',
  'tryOn.quickCancel',
  'search.historyTitle',
  'search.clearHistory',
  'search.trendingTitle',
...
const zhCNMessages = {
  ...
  'booking.result.tryOn': '虚拟试戴',
  'booking.quote.title': '你的报价',
  'booking.quote.back': '返回',
  'booking.quote.next': '选择时间',
  ...
  'booking.confirm.back': '← 返回',
  'booking.slots.loading': '正在加载可预约时间…',
  'booking.slots.error': '无法加载可预约时间，请返回重试',
  'booking.slots.empty': '暂无可用时段，请稍后再试',
  ...
  'tryOn.download': '下载图片',
  'tryOn.analyzeBook': '选择时间',
  'tryOn.commentLabel': '个性化需求（可选）',
  'tryOn.commentPlaceholder': '例如：杏仁形甲、偏长一些、光泽哑光…',
  'tryOn.commentError': '请输入与美甲相关的内容（如甲型、甲长、颜色等）。',
  'tryOn.quickConfirm': '确定',
  'tryOn.quickCancel': '取消',
  'search.historyTitle': '历史记录',
  'search.clearHistory': '清空',
  'search.trendingTitle': '当前热搜',
  'feed.searchPlaceholder': '搜索款式…',
  'feed.aria': '款式发现流',
  ...
  'feed.emptySavedTitle': '购物车是空的',
  'feed.emptySavedBody': '点击款式上的爱心，把喜欢的款式加入购物车。',
  'feed.card.save': '加入购物车',
  'feed.card.unsave': '从购物车移除',
