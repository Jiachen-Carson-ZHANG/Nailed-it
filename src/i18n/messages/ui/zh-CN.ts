...
export const uiMessageKeys = [
  ...
  'home.trending.loadingAction',
  'home.trending.errorTitle',
  'home.trending.loadingAria',
  'home.feed.aria',
  'home.feed.type',
  'home.feed.trending',
  'home.feed.saved',
  'home.feed.filterByTag',
  'home.feed.clearFilters',
  'home.feed.noMatchTitle',
  'home.feed.noMatchBody',
  'home.feed.emptySavedTitle',
  'home.feed.emptySavedBody',
  'home.feed.loadingTitle',
  'home.feed.loadingBody',
  'home.feed.errorTitle',
  'home.feed.errorBody',
  ...
  'booking.upload.chooseAction',
  'booking.upload.tryOnAction',
...
const zhCNMessages = {
  ...
  'home.trending.title': '热门',
  'home.trending.subtitle': 'AI 自动抓取近期热门款式',
  'home.trending.refresh': '刷新',
  'home.trending.loadingAction': '加载中…',
  'home.trending.errorTitle': '热门款式暂时无法加载',
  'home.trending.loadingAria': '正在加载热门款式',
  'home.feed.aria': '款式发现流',
  'home.feed.type': '款式类型',
  'home.feed.trending': '热门',
  'home.feed.saved': '收藏夹',
  'home.feed.filterByTag': '按标签筛选',
  'home.feed.clearFilters': '清除 ✕',
  'home.feed.noMatchTitle': '没有符合这些标签的款式',
  'home.feed.noMatchBody': '试着移除部分标签，或清空筛选查看全部款式。',
  'home.feed.emptySavedTitle': '还没有收藏款式',
  'home.feed.emptySavedBody': '点按任意款式上的爱心，就能把它收藏到这里。',
  'home.feed.loadingTitle': '正在加载商家款式',
  'home.feed.loadingBody': '正在获取最新发布的设计。',
  'home.feed.errorTitle': '款式暂时不可用',
  'home.feed.errorBody': '请刷新后重试，查看最新设计。',
  ...
  'booking.upload.chooseAction': '上传或拍照',
  'booking.upload.tryOnAction': '试戴款式',
