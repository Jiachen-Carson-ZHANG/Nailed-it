...
function buildPrompt(): string {
  ...
  return [
    ...
    '- 建构/延长 (structure): judge from nail length, thickness and tip seams whether the set is natural',
    '  (本甲 — then include NO structure billable) or extended. If extended, you MUST include exactly ONE',
    '  concrete structure billable: builder_gel, nail_tip_full_cover, nail_tip_half_cover or',
    '  nail_tip_shallow_cover. Naming only the container module (延长服务/建构服务) is NOT acceptable.',
    '',
